...
export const EXTERNAL_LINKS = {
  ...
  // ==========================================================================
  procurementWebhookUrl: ((typeof import.meta !== "undefined" && (import.meta as any).env?.VITE_PROCUREMENT_GAS_WEBHOOK_URL) as string) || "https://script.google.com/macros/s/AKfycbws1l7U0up8frC3lTblL7FJVVAD8j_rtitCQa0gT7L5OEKw_5U8fQONQNymuGz6YXv0/exec",

  // 請購系統對應的 Google 試算表或 Google 表單網址 (供管理備查)
  procurementSheetUrl: "https://script.google.com/macros/s/AKfycbws1l7U0up8frC3lTblL7FJVVAD8j_rtitCQa0gT7L5OEKw_5U8fQONQNymuGz6YXv0/exec",
