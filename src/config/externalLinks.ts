...
export const EXTERNAL_LINKS = {
  ...
  // ==========================================================================
  procurementWebhookUrl: ((typeof import.meta !== "undefined" && (import.meta as any).env?.VITE_PROCUREMENT_GAS_WEBHOOK_URL) as string) || "https://script.google.com/macros/s/AKfycbw7GXdcoWJbKmCQtaWQe8vECcCXhZJAtV0EloANvVeLF1iFpNgNuvvWIfn8aPP35l9V/exec",

  // 請購系統對應的 Google 試算表或 Google 表單網址 (供管理備查)
  procurementSheetUrl: "https://script.google.com/macros/s/AKfycbw7GXdcoWJbKmCQtaWQe8vECcCXhZJAtV0EloANvVeLF1iFpNgNuvvWIfn8aPP35l9V/exec",
